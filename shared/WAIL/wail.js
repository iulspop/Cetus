...
const OP_DELEGATE            = 0x18;
const OP_CATCH_ALL           = 0x19;
const OP_END                 = 0x0b;
const OP_BR                  = 0x0c;
const OP_BR_IF               = 0x0d;
...
class WailParser extends BufferReader {
    ...
    _readSection() {
        ...
        // The DataCount and Tag sections violate the usual rule that non-custom sections must
        // occur in numeric order. As a result, we must not assume a section is missing just
        // because we have encountered one of these sections
